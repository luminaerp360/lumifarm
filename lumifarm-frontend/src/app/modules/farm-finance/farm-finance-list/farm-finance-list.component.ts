...
export class FarmFinanceListComponent implements OnInit {
  ...
  loadPayments(): void {
    this.loading = true;
    this.FarmFinanceService.getAll(this.page, this.limit, this.search || undefined, this.statusFilter || undefined, this.methodFilter || undefined).subscribe({
  ...
  save(): void {
    ...
    this.saving = true;
    this.FarmFinanceService.create(this.form).subscribe({
